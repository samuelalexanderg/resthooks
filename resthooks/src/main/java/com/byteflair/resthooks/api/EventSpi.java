...
public interface EventSpi {
    ...
    @ResponseBody
    ResponseEntity<List<Event>> getResourceCollection() throws RestApiException;

    @RequestMapping(value="/{id}", method=RequestMethod.GET)
    @ResponseBody
    ResponseEntity<Event> getResource(@PathVariable("id") String id) throws RestApiException;
