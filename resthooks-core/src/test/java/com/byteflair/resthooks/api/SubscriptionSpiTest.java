...
public abstract class SubscriptionSpiTest {

    private final static Logger LOGGER=LoggerFactory.getLogger(SubscriptionSpiTest.class);
    private final SecureRandom secureRandom=new SecureRandom();
    private final List<Subscription> testSubscriptions=new ArrayList<>();
    ...
    private Subscription createSubscription() throws URISyntaxException, MalformedURLException {
        ...
        Subscription subscription=new SubscriptionImpl(new BigInteger(25, secureRandom).toString(32), url, new BigInteger(25, secureRandom).toString(32));
        return subscription;
    }
    ...
    @After
    public void clean() {
        for(Subscription subscription : testSubscriptions) {
